...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/usa/qwen2_5_3B_sft_usa_value.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs/USA'
RUN_NAME="sft_train_qwen2.5_usa_value_${SUFFIX}"
