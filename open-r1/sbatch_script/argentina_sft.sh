...
# YAML 配置文件路径
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/argentina/qwen2_5_3B_sft_argentina_value.yaml"

# 运行相关目录和名称
RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs/Spanish'
RUN_NAME="sft_train_qwen2.5_argentina_value_${SUFFIX}"
