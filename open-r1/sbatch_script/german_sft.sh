...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/german/qwen2_5_3B_sft_german_value.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs/German'
RUN_NAME="sft_train_qwen2.5_german_value_${SUFFIX}"
