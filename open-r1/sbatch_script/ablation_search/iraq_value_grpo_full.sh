#!/bin/bash
#SBATCH -J irqAblation                       
#SBATCH -o grpo_ablation_iraq.out                           
#SBATCH -p compute 
#SBATCH -N 1  
#SBATCH -t 12:00:00
...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/ablation_search/ablation_iraq_full.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs'
RUN_NAME="SearchRule_train_qwen2.5_iraq_value_${SUFFIX}"
