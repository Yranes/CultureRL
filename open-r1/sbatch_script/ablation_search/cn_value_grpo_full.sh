#!/bin/bash
#SBATCH -J cnAblation                       
#SBATCH -o ablationCNSearch.out                           
#SBATCH -p compute 
#SBATCH -N 1  
#SBATCH -t 15:00:00
#SBATCH --gres=gpu:a100x:2
#SBATCH --mem=50G                         
...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/ablation_search/ablation_cn_full.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs'
RUN_NAME="SearchRule_train_qwen2.5_cn_value_${SUFFIX}"
