...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/bengali/qwen2_5_3B_sft_bangladesh_value.yaml"

# 将语言目录从 Portuguese 修改为  (Bengali/孟加拉语)
RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs/Bengali'
