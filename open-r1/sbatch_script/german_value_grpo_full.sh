...
YAML_PATH="open-r1/recipes/wvs_value/german/qwen2_5_3B_german_full.yaml"
...
RESULTS_PATH="open-r1/runs/German/full_train_qwen2.5_german_value_${SUFFIX}/results"
