#!/bin/bash
#SBATCH -J br_sft                       ## <-- [不确定点 1]
#SBATCH -o brazilsft.out                           
#SBATCH -p compute 
#SBATCH -N 1  
#SBATCH -t 10:00:00
...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/brazil/qwen2_5_3B_sft_brazil_value.yaml" ## <-- [不确定点 2]

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs/Portuguese' ## <-- [不确定点 3]
