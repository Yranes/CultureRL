...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/usa/qwen2_5_3B_usa_full.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs'
RUN_NAME="full_train_qwen2.5_usa_value_${SUFFIX}"
RUN_DIR=${RUN_DIR_BASE}/USA/${RUN_NAME}
mkdir -p "${RUN_DIR}"
