...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/ablation/ablation_cn_full.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs'
RUN_NAME="ALLRule_train_qwen2.5_cn_value_${SUFFIX}"
