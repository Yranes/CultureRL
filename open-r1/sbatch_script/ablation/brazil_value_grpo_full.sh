#!/bin/bash
#SBATCH -J braAblation                       
#SBATCH -o ablationbra.out                           
#SBATCH -p compute 
#SBATCH -N 1  
#SBATCH -t 8:00:00
...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/ablation/ablation_brazil_full.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs'
RUN_NAME="ALLRule_train_qwen2.5_bra_value_${SUFFIX}"
