#!/bin/bash
#SBATCH -J turAblation                       
#SBATCH -o ablationtur.out                           
#SBATCH -p compute 
#SBATCH -N 1  
#SBATCH -t 8:00:00
...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/ablation/ablation_turkey_full.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs'
RUN_NAME="ALLRule_train_qwen2.5_tur_value_${SUFFIX}"
