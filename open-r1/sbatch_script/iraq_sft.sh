...
YAML_PATH="/home/hzli/code/WVS/open-r1/recipes/wvs_value/iraq/qwen2_5_3B_sft_iraq_value.yaml"

RUN_DIR_BASE='/home/hzli/code/WVS/open-r1/runs/Arabic'
RUN_NAME="sft_train_qwen2.5_iraq_value_${SUFFIX}"
