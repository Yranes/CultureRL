#!/bin/bash
#SBATCH -J argentinaEval                 # 修改: 作业名称
#SBATCH -o evalargentina.out               # 修改: 输出日志文件名
#SBATCH -p compute
#SBATCH -N 1
#SBATCH -t 5:00:00
...
TASK_NAME="full_train_qwen2.5_argentina_value_2025-07-17_21-31-21"
BASE_DIR="open-r1/runs/Spanish/full_train_qwen2.5_argentina_value_2025-07-17_21-31-21/results"
