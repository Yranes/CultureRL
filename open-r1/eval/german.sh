#!/bin/bash
#SBATCH -J germanEval                 # 修改: 作业名称
#SBATCH -o evalgerman.out               # 修改: 输出日志文件名
#SBATCH -p compute
#SBATCH -N 1
#SBATCH -t 10:00:00
...
# --- !! 重要：请将下面的 TASK_NAME 替换为您实际的德国运行任务名 !! ---
# 我已将 brazil_value -> german_value，您需要替换为真实的日期时间戳
TASK_NAME="full_train_qwen2.5_german_value_2025-07-18_19-29-25"
BASE_DIR="open-r1/runs/German/full_train_qwen2.5_german_value_2025-07-18_19-29-25/results"
