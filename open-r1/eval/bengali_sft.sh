#!/bin/bash
#SBATCH -J banglaEval                  # 修改: 作业名称，更具描述性
#SBATCH -o evalbangla.out                 # 修改: 输出日志文件名
#SBATCH -p compute 
#SBATCH -N 1   
#SBATCH -t 2:00:00
...
TASK_NAME="sft_train_qwen2.5_bangladesh_value_2025-07-16_21-09-26"
BASE_DIR=$1 # "open-r1/runs/Bengali/sft_train_qwen2.5_bangladesh_value_2025-07-16_21-09-26/results"
