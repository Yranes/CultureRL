#!/bin/bash
#SBATCH -J turkishEval                 # 修改: 作业名称
#SBATCH -o evalturkish.out               # 修改: 输出日志文件名
#SBATCH -p compute
#SBATCH -N 1
#SBATCH -t 5:00:00
...
TASK_NAME="full_train_qwen2.5_turkey_value_2025-07-17_22-27-24"
BASE_DIR="open-r1/runs/Turkish/full_train_qwen2.5_turkey_value_2025-07-17_22-27-24/results"
