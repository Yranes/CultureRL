...
# --- 2. 定义推理结果的基础路径 ---
INFER_BASE_PATH=$1 # "open-r1/infer/PT_Arabic_2025-07-19_21-17-31" # "open-r1/infer/PT_Arabic_2025-07-20_01-13-03/" # "open-r1/infer/PT_Arabic_2025-07-20_01-13-03/arabic/" # "open-r1/infer/sft_train_qwen2.5_iraq_value_2025-07-20_00-54-09" # "open-r1/infer/gpt-4o/Arabic/"
...
run_scoring() {
    ...
    local WVS_SPA_INPUT_FILE="$TARGET_PATH/wvs_question2_IRQ.json"
...
# --- 5. 新增逻辑：检查是否存在 checkpoint 目录并选择执行模式 ---
