...
# --- 2. 定义推理结果的基础路径 ---
INFER_BASE_PATH=$1 # "open-r1/infer/full_train_qwen2.5_turkey_value_2025-07-17_22-27-24" # "open-r1/infer/Qwen2.5-3B-Instruct/turkish" # "open-r1/infer/sft_train_qwen2.5_turkey_value_2025-07-17_15-33-20/" # "open-r1/infer/Qwen2.5-3B-Instruct/german" # "open-r1/infer/full_train_qwen2.5_german_value_2025-07-16_14-49-07/"
...
run_scoring() {
    ...
    local WVS_SPA_INPUT_FILE="$TARGET_PATH/wvs_question2_TUR.json"
