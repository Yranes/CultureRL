...
# 修改: 将语言从 korean 修改为 spanish
LANGUAGE="spanish"
LANGUAGE_CAP="Spanish"

# --- 2. 定义推理结果的基础路径 ---
# 修改: 根据您的要求更新路径
INFER_BASE_PATH=$1 # "open-r1/infer/full_train_qwen2.5_argentina_value_2025-07-17_21-31-21" # "open-r1/infer/sft_train_qwen2.5_argentina_value_2025-07-17_19-26-44"
...
run_scoring() {
    ...
    # 修改: 将WVS文件中的国家代码从 KOR 修改为 ARG (阿根廷)
    local WVS_SPA_INPUT_FILE="$TARGET_PATH/wvs_question2_ARG.json"
